...
options= {
    chart: {
        width: columnChartWidth, height:380, title:"Monthly Revenue", format:"1,000"
    }

    ,
    yAxis: {
        title: "Amount", min:0, max:9e3
    }
...
$(window).resize(function() {
        columnChartWidth=$("#column-charts").width(), columnChart.resize({
            width:columnChartWidth, height:350
        })
});
...
options= {
    chart: {
        width: lineChartWidth, height:380, title:"24-hr Average Temperature"
    }

    ,
    yAxis: {
        title: "Amount", pointOnColumn: !0
    }
...
$(window).resize(function() {
        lineChartWidth=$("#line-charts").width(), lineChart.resize({
            width:lineChartWidth, height:350
        })
});
...
options= {
    chart: {
        width: areaChartWidth, height:380, title:"24-hr Average Temperature"
    }

    ,
    series: {
        zoomable: !0, showDot: !1, areaOpacity:1
    }

    ,
    yAxis: {
        title: "Temperature (Celsius)", pointOnColumn: !0
    }
...
$(window).resize(function() {
        areaChartWidth=$("#area-charts").width(), areaChart.resize({
            width:areaChartWidth, height:350
        })
});
...
options= {
    chart: {
        title: "Annual Incomes", width:radialChartWidth, height:380
    }
...
$(window).resize(function() {
        radialChartWidth=$("#radial-charts").width(), radialChart.resize({
            width:radialChartWidth, height:350
        })
});
...
options= {
    chart: {
        ...
        format:function(e, a, t, r) {
            return"r" !==r&&"x" !==r||(e=tui.chart.renderUtil.formatToComma(e), "x"===r&&(e="$" +e)),
            e
        }
    }
...
$(window).resize(function() {
        bubbleChartWidth=$("#bubble-charts").width(), bubbleChart.resize({
            width:bubbleChartWidth, height:350
        })
});
...
options= {
    chart: {
        width: scatterChartWidth, height:380, title:"Height vs Weight"
    }
...
$(window).resize(function() {
        scatterChartWidth=$("#scatter-charts").width(), scatterChart.resize({
            width:scatterChartWidth, height:350
        })
});
...
options= {
    chart: {
        width: pieChartWidth, height:380, title:"Usage share of web browsers"
    }
...
$(window).resize(function() {
        pieChartWidth=$("#pie-charts").width(), pieChart.resize({
            width:pieChartWidth, height:350
        })
});
...
options= {
    ...
    ,
    series: {
        radiusRange: ["40%", "100%"], showLabel: !0
    }
...
$(window).resize(function() {
        donutpieChartWidth=$("#donut-charts").width(), donutChart.resize({
            width:donutpieChartWidth, height:350
        })
});
...
data= {
    categories: {
        x: ["Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sep", "Oct", "Nov", "Dec"], y:["Seoul", "Seattle", "Sydney", "Moskva", "Jungfrau"]
    }
...
options= {
    chart: {
        width: heatmapchartsWidth, height:380, title:"24-hr Average Temperature"
    }
...
theme= {
    ...
    ,
    series: {
        startColor: "#556ee6", endColor:"#34c38f", overColor:"#75b5aa", borderColor:"#F4511E"
    }
}
...
$(window).resize(function() {
        heatmapChartChartWidth=$("#heatmap-charts").width(), heatmapChart.resize({
            width:heatmapChartChartWidth, height:350
        })
});
...
options= {
    chart: {
        width: treemapchartsWidth, height:380, title:"Used disk space"
    }

    ,
    series: {
        showLabel: !0, zoomable: !1, useLeafLabel: !0
    }
...
theme= {
    ...
    ,
    series: {
        colors: ["#556ee6", "#34c38f", "#f1b44c", "#f46a6a"], borderColor:"rgba(255, 255, 255, 0.4)", borderWidth:4
    }
}
...
$(window).resize(function() {
        treemapChartChartWidth=$("#treemap-charts").width(), treemapChart.resize({
            width:treemapChartChartWidth, height:350
        })
});
...
options= {
    chart: {
        width: mapchartsWidth, height:380, title:"Average annual temperature of USA (°C)"
    }
...
$(window).resize(function() {
        mapChartChartWidth=$("#map-charts").width(), mapChart.resize({
            width:mapChartChartWidth, height:350
        })
});
...
data= {
    ...
    "Debt"],
    series:[ {
        name: "2015", data:[[1e3, 2500, 3714, 5500, 7e3], [1e3, 2750, 4571, 5250, 8e3], [3e3, 4e3, 4714, 6e3, 7e3], [1e3, 2250, 3142, 4750, 6e3]], outliers:[[0, 14e3], [2, 1e4], [3, 9600]]
    }

    ,
    {
    name: "2016", data:[[2e3, 4500, 6714, 11500, 13e3], [3e3, 5750, 7571, 8250, 9e3], [5e3, 8e3, 8714, 9e3, 1e4], [7e3, 9250, 10142, 11750, 12e3]], outliers:[[1, 14e3]]
}
...
options= {
    chart: {
        width: boxplotchartsWidth, height:380, title:"Monthly Revenue", format:"1,000"
    }

    ,
    yAxis: {
        title: "Amount", min:0, max:15e3
    }
...
$(window).resize(function() {
        boxplotChartChartWidth=$("#boxplot-charts").width(), boxplotChart.resize({
            width:boxplotChartChartWidth, height:350
        })
});
...
data= {
    ...
    "August"],
    series:[ {
        name: "Budget", data:25, markers:[28, 2, 15], ranges:[[-1, 10], [10, 20], [20, 30]]
    }

    ,
    {
    name: "Hello", data:11, markers:[20], ranges:[[0, 8], [8, 15]]
}
...
,
{
name: "Income", data:23, markers:[], ranges:[[19, 25], [13, 19], [0, 13]]
}
...
options= {
    chart: {
        width: bulletchartsWidth, height:380, title:"Monthly Revenue", format:"1,000"
    }
...
$(window).resize(function() {
        bulletChartWidth=$("#bullet-charts").width(), bulletChart.resize({
            width:bulletChartWidth, height:350
        })
});