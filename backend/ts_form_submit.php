...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $UMC1 = isset($_POST['UMC1']) ? $_POST['UMC1'] : '';
    $UMC2 = isset($_POST['UMC2']) ? $_POST['UMC2'] : '';
    $UMC3 = isset($_POST['UMC3']) ? $_POST['UMC3'] : '';
    $UMC4 = isset($_POST['UMC4']) ? $_POST['UMC4'] : '';
    $UMC5 = isset($_POST['UMC5']) ? $_POST['UMC5'] : '';
